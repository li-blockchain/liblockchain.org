...
export default function VaultSidebar({ className = '' }: VaultSidebarProps) {
  ...
  const isActive = (path: string) => {
    if (path === '/app/my-vaults') {
      return router.pathname === '/app/my-vaults'
    }
    if (path === '/app/create-vault') {
      return router.pathname === '/app/create-vault'
    }
    if (path === '/app/vault-status') {
      return router.pathname === '/app/vault-status'
    }
    return false
  }
